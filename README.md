...
SpellingHero is just someone who wants to get started on open source
...
SpellingHero will be the first in a line of Github bots. Who knows?
...
better results. I started out with the [python
documentation](https://docs.python.org/3/download.html). In the future, I'll
